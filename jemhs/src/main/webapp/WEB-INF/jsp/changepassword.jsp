...
<h4 align="center">${message}</h4>
	<div class="container">
		<form:form class="form-horizontal" action="changePassword" modelAttribute="changePass">
			...
			<button type="submit" class="btn-lg btn-primary center-block">Change Password</button>
		</form:form>
	</div>
